...
type VersionRecord struct {
	...
	NomadVersion string
	// GitopsRelease is the nomad-gitops release tag, e.g. "v0.3.0".
	GitopsRelease string
...
// Update after each nomad-gitops release:
//
